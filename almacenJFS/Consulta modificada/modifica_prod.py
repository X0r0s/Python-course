...
from consulta_prod import consprod
from carga_almacen import muestra_productos #luego de importarlo ya reconoce a la tabla como tal
class modificaproductos(QDialog, consprod):
	def __init__(self):
		super().__init__()
